...
# what we want to take a list of our functions and use them in our application
...
# so this file is our module "helpers.py"
# this file can contain x number of functions
# ***********************************************************
# Below is our normal function to practice using modules
# this function accepts two parameters (this function is expecting to receive two input/values):
# message: should be a string by default but it can be any data type!!!!
# is_raining: boolean either True (Yes) or False (No)
